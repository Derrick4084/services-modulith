package com.derocode.EcommApp.jwt;
...
public class SharedJwtService {
    ...
    public String generateTokenWithRoles(@NonNull Authentication authentication, String userType) {
    ...
    public String generateTokenNoRoles(String username, String userType) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("type", userType);
        return Jwts.builder()
                .subject(username)
