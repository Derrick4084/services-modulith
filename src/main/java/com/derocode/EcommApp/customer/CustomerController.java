...
public class CustomerController {
    ...
    public ResponseEntity<String> authenticateCustomer(@Valid @RequestBody @NonNull CustomerLoginRequestDto loginRequest) {
        try {
    ...
    public ResponseEntity<CustomerResponseDto> addCustomer(@Valid @RequestBody AddCustomerRequestDto request){
